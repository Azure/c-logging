...
static int bool_log_context_property_type_copy(void* dst_value, const void* src_value)
{
    int result;
    if (
        /* Codes_SRS_LOG_CONTEXT_PROPERTY_BOOL_TYPE_07_006: [ If dst_value is NULL, LOG_CONTEXT_PROPERTY_TYPE_IF_IMPL(bool).copy shall fail and return a non-zero value. ]*/
        (dst_value == NULL) ||
        /* Codes_SRS_LOG_CONTEXT_PROPERTY_BOOL_TYPE_07_005: [ If src_value is NULL, LOG_CONTEXT_PROPERTY_TYPE_IF_IMPL(bool).copy shall fail and return a non-zero value. ]*/
        (src_value == NULL)
        )
    {
    ...
    {
        /* Codes_SRS_LOG_CONTEXT_PROPERTY_BOOL_TYPE_07_007: [ LOG_CONTEXT_PROPERTY_TYPE_IF_IMPL(bool).copy shall copy the bytes of the bool value from the address pointed by src_value to dst_value. ]*/
        (void)memcpy(dst_value, src_value, sizeof(bool));
        /* Codes_SRS_LOG_CONTEXT_PROPERTY_BOOL_TYPE_07_008: [ LOG_CONTEXT_PROPERTY_TYPE_IF_IMPL(bool).copy shall succeed and return 0. ]*/
        result = 0;
    }
    return result;
}
...
{
    /* Codes_SRS_LOG_CONTEXT_PROPERTY_BOOL_TYPE_07_009: [ LOG_CONTEXT_PROPERTY_TYPE_IF_IMPL(bool).free shall return. ]*/
    (void)value;
}

static LOG_CONTEXT_PROPERTY_TYPE bool_log_context_property_type_get_type(void)
{
    /* Codes_SRS_LOG_CONTEXT_PROPERTY_BOOL_TYPE_07_010: [ LOG_CONTEXT_PROPERTY_TYPE_IF_IMPL(bool).get_type shall return the property type LOG_CONTEXT_PROPERTY_TYPE_bool. ]*/
...
{
    /* Codes_SRS_LOG_CONTEXT_PROPERTY_BOOL_TYPE_07_014: [ LOG_CONTEXT_PROPERTY_TYPE_GET_INIT_DATA_SIZE(bool) shall return sizeof(bool). ]*/
