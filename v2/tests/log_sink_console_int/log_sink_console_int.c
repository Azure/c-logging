...
static void log_sink_console_prints_an_empty_string(void)
{
    ...
    // act
    log_sink_console.log_sink_log(LOG_LEVEL_CRITICAL, NULL, __FILE__, __FUNCTION__, __LINE__, "");
...
static void log_sink_console_prints_with_CRITICAL_a_simple_log(void)
{
    ...
    // act
    log_sink_console.log_sink_log(LOG_LEVEL_CRITICAL, NULL, __FILE__, __FUNCTION__, __LINE__, "a");
...
static void log_sink_console_prints_with_ERROR_a_simple_log(void)
{
    ...
    // act
    log_sink_console.log_sink_log(LOG_LEVEL_ERROR, NULL, __FILE__, __FUNCTION__, __LINE__, "a");
...
static void log_sink_console_prints_with_WARNING_a_simple_log(void)
{
    ...
    // act
    log_sink_console.log_sink_log(LOG_LEVEL_WARNING, NULL, __FILE__, __FUNCTION__, __LINE__, "a");
...
static void log_sink_console_prints_with_INFO_a_simple_log(void)
{
    ...
    // act
    log_sink_console.log_sink_log(LOG_LEVEL_INFO, NULL, __FILE__, __FUNCTION__, __LINE__, "a");
...
static void log_sink_console_prints_with_VERBOSE_a_simple_log(void)
{
    ...
    // act
    log_sink_console.log_sink_log(LOG_LEVEL_VERBOSE, NULL, __FILE__, __FUNCTION__, __LINE__, "a");
...
static void log_sink_console_prints_with_several_arguments_for_the_message(void)
{
    ...
    // act
    log_sink_console.log_sink_log(LOG_LEVEL_VERBOSE, NULL, __FILE__, __FUNCTION__, __LINE__, "%s is %d years old", "Gogu", 100);
...
static void log_sink_console_prints_with_NULL_file_works(void)
{
    ...
    // act
    log_sink_console.log_sink_log(LOG_LEVEL_VERBOSE, NULL, NULL, __FUNCTION__, __LINE__, "");
...
static void log_sink_console_prints_with_NULL_function_works(void)
{
    ...
    // act
    log_sink_console.log_sink_log(LOG_LEVEL_VERBOSE, NULL, __FILE__, NULL, __LINE__, "");
...
static void log_sink_console_with_empty_context_works(void)
{
    ...
    // act
    log_sink_console.log_sink_log(LOG_LEVEL_VERBOSE, &test_context, __FILE__, __FUNCTION__, __LINE__, "");
...
static void log_sink_console_with_context_with_parent_works(void)
{
    ...
    // act
    log_sink_console.log_sink_log(LOG_LEVEL_VERBOSE, &test_context_2, __FILE__, __FUNCTION__, __LINE__, "");
...
static void log_sink_console_with_a_chain_of_3_contexts_works(void)
{
    ...
    // act
    log_sink_console.log_sink_log(LOG_LEVEL_VERBOSE, &test_context_3, __FILE__, __FUNCTION__, __LINE__, "");
