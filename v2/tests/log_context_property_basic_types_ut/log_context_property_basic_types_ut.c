...
static void int64_t_to_string_with_NULL_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(int64_t).to_string(NULL, buffer, TEST_BUFFER_SIZE);
...
static void int64_t_copy_called_with_NULL_dst_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(int64_t).copy(NULL, &src);
...
static void int64_t_copy_called_with_NULL_src_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(int64_t).copy(&dst, NULL);
...
static void int64_t_copy_succeeds(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(int64_t).copy(&dst, &src);
...
static void int64_t_free_returns(void)
{
    ...
    // act
    LOG_CONTEXT_PROPERTY_TYPE_IMPL(int64_t).free(&value);
...
static void int64_t_get_type_returns_LOG_CONTEXT_PROPERTY_TYPE_int64_t(void)
{
    ...
    // act
    LOG_CONTEXT_PROPERTY_TYPE result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(int64_t).get_type();
...
static void uint64_t_to_string_with_NULL_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint64_t).to_string(NULL, buffer, TEST_BUFFER_SIZE);
...
static void uint64_t_copy_called_with_NULL_dst_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint64_t).copy(NULL, &src);
...
static void uint64_t_copy_called_with_NULL_src_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint64_t).copy(&dst, NULL);
...
static void uint64_t_copy_succeeds(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint64_t).copy(&dst, &src);
...
static void uint64_t_free_returns(void)
{
    ...
    // act
    LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint64_t).free(&value);
...
static void uint64_t_get_type_returns_LOG_CONTEXT_PROPERTY_TYPE_uint64_t(void)
{
    ...
    // act
    LOG_CONTEXT_PROPERTY_TYPE result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint64_t).get_type();
...
/* Tests_SRS_LOG_CONTEXT_PROPERTY_BASIC_TYPES_01_025: [ If src_value is NULL, LOG_CONTEXT_PROPERTY_TYPE_IMPL(int32_t).copy shall fail and return a non-zero value. ]*/
...
/* Tests_SRS_LOG_CONTEXT_PROPERTY_BASIC_TYPES_01_026: [ If dst_value is NULL, LOG_CONTEXT_PROPERTY_TYPE_IMPL(int32_t).copy shall fail and return a non-zero value. ]*/
...
/* Tests_SRS_LOG_CONTEXT_PROPERTY_BASIC_TYPES_01_027: [ LOG_CONTEXT_PROPERTY_TYPE_IMPL(int32_t).copy shall copy the bytes of the int32_t value from the address pointed by src_value to dst_value. ]*/
/* Tests_SRS_LOG_CONTEXT_PROPERTY_BASIC_TYPES_01_028: [ LOG_CONTEXT_PROPERTY_TYPE_IMPL(int32_t).copy shall succeed and return 0. ]*/
...
/* Tests_SRS_LOG_CONTEXT_PROPERTY_BASIC_TYPES_01_029: [ LOG_CONTEXT_PROPERTY_TYPE_IMPL(int32_t).free shall return. ]*/
...
/* Tests_SRS_LOG_CONTEXT_PROPERTY_BASIC_TYPES_01_030: [ LOG_CONTEXT_PROPERTY_TYPE_IMPL(int32_t).get_type shall returns the property type LOG_CONTEXT_PROPERTY_TYPE_int32_t. ]*/
...
static void uint32_t_to_string_with_NULL_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint32_t).to_string(NULL, buffer, TEST_BUFFER_SIZE);
...
static void uint32_t_copy_called_with_NULL_dst_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint32_t).copy(NULL, &src);
...
static void uint32_t_copy_called_with_NULL_src_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint32_t).copy(&dst, NULL);
...
static void uint32_t_copy_succeeds(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint32_t).copy(&dst, &src);
...
static void uint32_t_free_returns(void)
{
    ...
    // act
    LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint32_t).free(&value);
...
static void uint32_t_get_type_returns_LOG_CONTEXT_PROPERTY_TYPE_uint32_t(void)
{
    ...
    // act
    LOG_CONTEXT_PROPERTY_TYPE result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint32_t).get_type();
...
static void int16_t_to_string_with_NULL_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(int16_t).to_string(NULL, buffer, TEST_BUFFER_SIZE);
...
/* Tests_SRS_LOG_CONTEXT_PROPERTY_BASIC_TYPES_01_045: [ If src_value is NULL, LOG_CONTEXT_PROPERTY_TYPE_IMPL(int16_t).copy shall fail and return a non-zero value. ]*/
static void int16_t_copy_called_with_NULL_dst_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(int16_t).copy(NULL, &src);
...
/* Tests_SRS_LOG_CONTEXT_PROPERTY_BASIC_TYPES_01_046: [ If dst_value is NULL, LOG_CONTEXT_PROPERTY_TYPE_IMPL(int16_t).copy shall fail and return a non-zero value. ]*/
static void int16_t_copy_called_with_NULL_src_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(int16_t).copy(&dst, NULL);
...
/* Tests_SRS_LOG_CONTEXT_PROPERTY_BASIC_TYPES_01_047: [ LOG_CONTEXT_PROPERTY_TYPE_IMPL(int16_t).copy shall copy the bytes of the int16_t value from the address pointed by src_value to dst_value. ]*/
/* Tests_SRS_LOG_CONTEXT_PROPERTY_BASIC_TYPES_01_048: [ LOG_CONTEXT_PROPERTY_TYPE_IMPL(int16_t).copy shall succeed and return 0. ]*/
static void int16_t_copy_succeeds(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(int16_t).copy(&dst, &src);
...
/* Tests_SRS_LOG_CONTEXT_PROPERTY_BASIC_TYPES_01_049: [ LOG_CONTEXT_PROPERTY_TYPE_IMPL(int16_t).free shall return. ]*/
static void int16_t_free_returns(void)
{
    ...
    // act
    LOG_CONTEXT_PROPERTY_TYPE_IMPL(int16_t).free(&value);
...
/* Tests_SRS_LOG_CONTEXT_PROPERTY_BASIC_TYPES_01_050: [ LOG_CONTEXT_PROPERTY_TYPE_IMPL(int16_t).get_type shall returns the property type LOG_CONTEXT_PROPERTY_TYPE_int16_t. ]*/
static void int16_t_get_type_returns_LOG_CONTEXT_PROPERTY_TYPE_int16_t(void)
{
    ...
    // act
    LOG_CONTEXT_PROPERTY_TYPE result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(int16_t).get_type();
...
static void uint16_t_to_string_with_NULL_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint16_t).to_string(NULL, buffer, TEST_BUFFER_SIZE);
...
static void uint16_t_copy_called_with_NULL_dst_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint16_t).copy(NULL, &src);
...
static void uint16_t_copy_called_with_NULL_src_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint16_t).copy(&dst, NULL);
...
static void uint16_t_copy_succeeds(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint16_t).copy(&dst, &src);
...
static void uint16_t_free_returns(void)
{
    ...
    // act
    LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint16_t).free(&value);
...
static void uint16_t_get_type_returns_LOG_CONTEXT_PROPERTY_TYPE_uint16_t(void)
{
    ...
    // act
    LOG_CONTEXT_PROPERTY_TYPE result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint16_t).get_type();
...
static void int8_t_to_string_with_NULL_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(int8_t).to_string(NULL, buffer, TEST_BUFFER_SIZE);
...
/* Tests_SRS_LOG_CONTEXT_PROPERTY_BASIC_TYPES_01_065: [ If src_value is NULL, LOG_CONTEXT_PROPERTY_TYPE_IMPL(int8_t).copy shall fail and return a non-zero value. ]*/
static void int8_t_copy_called_with_NULL_dst_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(int8_t).copy(NULL, &src);
...
/* Tests_SRS_LOG_CONTEXT_PROPERTY_BASIC_TYPES_01_066: [ If dst_value is NULL, LOG_CONTEXT_PROPERTY_TYPE_IMPL(int8_t).copy shall fail and return a non-zero value. ]*/
static void int8_t_copy_called_with_NULL_src_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(int8_t).copy(&dst, NULL);
...
static void int8_t_copy_succeeds(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(int8_t).copy(&dst, &src);
...
/* Tests_SRS_LOG_CONTEXT_PROPERTY_BASIC_TYPES_01_069: [ LOG_CONTEXT_PROPERTY_TYPE_IMPL(int8_t).free shall return. ]*/
static void int8_t_free_returns(void)
{
    ...
    // act
    LOG_CONTEXT_PROPERTY_TYPE_IMPL(int8_t).free(&value);
...
/* Tests_SRS_LOG_CONTEXT_PROPERTY_BASIC_TYPES_01_070: [ LOG_CONTEXT_PROPERTY_TYPE_IMPL(int8_t).get_type shall returns the property type LOG_CONTEXT_PROPERTY_TYPE_int8_t. ]*/
static void int8_t_get_type_returns_LOG_CONTEXT_PROPERTY_TYPE_int8_t(void)
{
    ...
    // act
    LOG_CONTEXT_PROPERTY_TYPE result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(int8_t).get_type();
...
static void uint8_t_to_string_with_NULL_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint8_t).to_string(NULL, buffer, TEST_BUFFER_SIZE);
...
static void uint8_t_copy_called_with_NULL_dst_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint8_t).copy(NULL, &src);
...
static void uint8_t_copy_called_with_NULL_src_value_fails(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint8_t).copy(&dst, NULL);
...
static void uint8_t_copy_succeeds(void)
{
    ...
    // act
    int result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint8_t).copy(&dst, &src);
...
static void uint8_t_free_returns(void)
{
    ...
    // act
    LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint8_t).free(&value);
...
static void uint8_t_get_type_returns_LOG_CONTEXT_PROPERTY_TYPE_uint8_t(void)
{
    ...
    // act
    LOG_CONTEXT_PROPERTY_TYPE result = LOG_CONTEXT_PROPERTY_TYPE_IMPL(uint8_t).get_type();
