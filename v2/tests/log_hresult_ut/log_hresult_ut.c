...
#if 0
/* Tests_SRS_LOG_LASTERROR_01_003: [ Otherwise, log_hresult_fill_property shall call GetLastError to obtain the last error information. ] */
/* Tests_SRS_LOG_LASTERROR_01_004: [ log_hresult_fill_property shall call FormatMessageA with FORMAT_MESSAGE_FROM_SYSTEM | FORMAT_MESSAGE_IGNORE_INSERTS, the last error value, LANG_NEUTRAL as language Id, buffer as buffer to place the output and 512 as buffer size. ] */
...
/* Tests_SRS_LOG_LASTERROR_01_007: [ log_hresult_fill_property shall return 512. ] */
static void log_hresult_fill_property_with_non_NULL_formats_last_error_995(void)
{
    // arrange
    char buffer[512];
...
/* Tests_SRS_LOG_LASTERROR_01_006: [ Otherwise, log_hresult_fill_property shall remove any \r or \n characters that have been placed at the end of the formatted output by FormatMessageA. ] */
/* Tests_SRS_LOG_LASTERROR_01_007: [ log_hresult_fill_property shall return 512. ] */
static void log_hresult_fill_property_with_non_NULL_formats_last_error_42(void)
{
    // arrange
    char buffer[512];
...
int main(void)
{
    ...
    //log_hresult_fill_property_with_non_NULL_formats_last_error_995();
    //log_hresult_fill_property_with_non_NULL_formats_last_error_42();
    //
