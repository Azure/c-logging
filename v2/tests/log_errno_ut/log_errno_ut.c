...
/* Tests_SRS_LOG_HRESULT_01_001: [ If buffer is NULL, log_errno_fill_property shall return 512 to indicate how many bytes shall be reserved for the HRESULT string formatted version. ] */
...
#if 0
/* Tests_SRS_LOG_HRESULT_01_002: [ log_errno_fill_property shall call FormatMessageA_no_newline with FORMAT_MESSAGE_FROM_SYSTEM | FORMAT_MESSAGE_IGNORE_INSERTS, hresult, 0 as language Id, buffer as buffer to place the output and 512 as buffer size. ] */
/* Tests_SRS_LOG_HRESULT_01_003: [ log_lasterror_fill_property shall return 512. ] */
static void log_errno_fill_property_with_non_NULL_formats_S_OK(void)
{
    // arrange
    char buffer[512];
    ...
    // act
    int result = log_errno_fill_property(buffer, S_OK);
...
/* Tests_SRS_LOG_HRESULT_01_002: [ log_errno_fill_property shall call FormatMessageA_no_newline with FORMAT_MESSAGE_FROM_SYSTEM | FORMAT_MESSAGE_IGNORE_INSERTS, hresult, 0 as language Id, buffer as buffer to place the output and 512 as buffer size. ] */
/* Tests_SRS_LOG_HRESULT_01_003: [ log_lasterror_fill_property shall return 512. ] */
static void log_errno_fill_property_with_non_NULL_formats_E_FAIL(void)
{
    // arrange
    char buffer[512];
    ...
    // act
    int result = log_errno_fill_property(buffer, E_FAIL);
...
/* Tests_SRS_LOG_HRESULT_01_004: [ If FormatMessageA_no_newline returns 0, log_errno_fill_property attempt to look up the formatted string from the loaded modules: ] */
/* Tests_SRS_LOG_HRESULT_01_005: [ log_errno_fill_property shall get the current process handle by calling GetCurrentProcess. ] */
/* Tests_SRS_LOG_HRESULT_01_006: [ log_errno_fill_property shall call EnumProcessModules and obtain the information about 10 modules. ] */
/* Tests_SRS_LOG_HRESULT_01_007: [ If no module has the formatted message, log_errno_fill_property shall place in buffer the string unknown HRESULT 0x%x, where %x is the hresult value. ] */
static void when_FormatMessageA_fails_and_no_modules_are_returned_log_errno_fill_property_places_unknown_hresult_in_buffer(void)
{
    // arrange
    char buffer[512];
...
/* Tests_SRS_LOG_HRESULT_01_008: [ If printing the unknown HRESULT 0x%x string fails, log_errno_fill_property shall place in buffer the string snprintf failed. ] */
static void when_snprintf_fails_log_errno_fill_property_places_snprintf_failed_in_the_buffer(void)
{
    // arrange
    char buffer[512];
...
/* Tests_SRS_LOG_HRESULT_01_009: [ If EnumProcessModules fails, log_errno_fill_property shall place in buffer a string indicating what failed, the last error and unknown HRESULT 0x%x, where %x is the hresult value. ] */
static void when_EnumProcessModules_fails_log_errno_fill_property_places_unknown_hresult_with_lasterror_in_buffer(void)
{
    // arrange
    char buffer[512];
...
/* Tests_SRS_LOG_HRESULT_01_008: [ If printing the unknown HRESULT 0x%x string fails, log_errno_fill_property shall place in buffer the string snprintf failed. ] */
static void when_snprintf_fails_after_EnumProcessModules_fails_log_errno_fill_property_places_snprintf_failed_in_the_buffer(void)
{
    // arrange
    char buffer[512];
...
/* Tests_SRS_LOG_HRESULT_01_011: [ log_errno_fill_property shall call FormatMessageA with FORMAT_MESSAGE_FROM_HMODULE | FORMAT_MESSAGE_IGNORE_INSERTS, the module handle, the hresult value, 0 as language Id, buffer as buffer to place the output and 512 as buffer size. ] */
static void when_first_module_out_of_2_FormatMessageA_no_newline_formats_log_errno_fill_property_formats_success(void)
{
    // arrange
    char buffer[512];
...
/* Tests_SRS_LOG_HRESULT_01_010: [ For each module: ] */
/* Tests_SRS_LOG_HRESULT_01_011: [ log_errno_fill_property shall call FormatMessageA with FORMAT_MESSAGE_FROM_HMODULE | FORMAT_MESSAGE_IGNORE_INSERTS, the module handle, the hresult value, 0 as language Id, buffer as buffer to place the output and 512 as buffer size. ] */
static void when_2nd_module_out_of_2_FormatMessageA_no_newline_formats_log_errno_fill_property_formats_success(void)
{
    // arrange
    char buffer[512];
    HMODULE test_modules[] = { TEST_MODULE_1, TEST_MODULE_2 };
...
/* Tests_SRS_LOG_HRESULT_01_007: [ If no module has the formatted message, log_errno_fill_property shall place in buffer the string unknown HRESULT 0x%x, where %x is the hresult value. ] */
static void when_none_of_2_FormatMessageA_no_newline_formats_it_log_errno_fill_property_formats_yields_unknown(void)
{
    // arrange
    char buffer[512];
    HMODULE test_modules[] = { TEST_MODULE_1, TEST_MODULE_2 };
...
/* Tests_SRS_LOG_HRESULT_01_012: [ LOG_HRESULT shall expand to a LOG_CONTEXT_PROPERTY_CUSTOM_FUNCTION with name hresult, type ascii_char_ptr and value function call being log_errno_fill_property(hresult). ] */
...
int main(void)
{
    ...
    //log_errno_fill_property_with_non_NULL_formats_S_OK();
    //log_errno_fill_property_with_non_NULL_formats_E_FAIL();
    
    //when_FormatMessageA_fails_and_no_modules_are_returned_log_errno_fill_property_places_unknown_hresult_in_buffer();
    //when_snprintf_fails_log_errno_fill_property_places_snprintf_failed_in_the_buffer();
    //when_EnumProcessModules_fails_log_errno_fill_property_places_unknown_hresult_with_lasterror_in_buffer();
    //when_snprintf_fails_after_EnumProcessModules_fails_log_errno_fill_property_places_snprintf_failed_in_the_buffer();
    //
    //when_first_module_out_of_2_FormatMessageA_no_newline_formats_log_errno_fill_property_formats_success();
    //when_2nd_module_out_of_2_FormatMessageA_no_newline_formats_log_errno_fill_property_formats_success();
    //when_none_of_2_FormatMessageA_no_newline_formats_it_log_errno_fill_property_formats_yields_unknown();
    //
